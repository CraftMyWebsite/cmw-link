package fr.CraftMyWebsite.CMWLink.Common.Utils.v1_18_R1;
...
public class OfflinePlayerLoader_v1_18_R1 extends OfflinePlayerLoader{
	...
	public Player loadFromOfflinePlayer(OfflinePlayer player) {
		...
		EntityPlayer entity = new EntityPlayer(server, server.F().iterator().next(), profile);
