package fr.CraftMyWebsite.CMWLink.Common.Utils.v1_21_R1;
...
public class OfflinePlayerLoader_v1_21_R1 extends OfflinePlayerLoader{
	...
	public Player loadFromOfflinePlayer(OfflinePlayer player) {
		...
		//TODO FIX WORLD
		EntityPlayer entity = new EntityPlayer(server, server.I(), profile, ClientInformation.a());
