package fr.CraftMyWebsite.CMWLink.Common.Utils.v1_21_R3;
...
public class OfflinePlayerLoader_v1_21_R3 extends OfflinePlayerLoader{
	...
	public Player loadFromOfflinePlayer(OfflinePlayer player) {
		...
		EntityPlayer entity = new EntityPlayer(server, server.J(), profile, ClientInformation.a());
