package fr.CraftMyWebsite.CMWLink.Common.Utils.v1_19_R2;
...
public class OfflinePlayerLoader_v1_19_R2 extends OfflinePlayerLoader {
    ...
    public Player loadFromOfflinePlayer(OfflinePlayer player) {
        ...
        EntityPlayer entity = new EntityPlayer(server, server.E().iterator().next(), profile);
