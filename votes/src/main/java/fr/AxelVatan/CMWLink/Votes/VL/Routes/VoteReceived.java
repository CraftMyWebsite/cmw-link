...
public class VoteReceived extends CMWLRoute<Main>{
	...
	public String executeRoute(HashMap<String, String> params) {
		...
		this.getPlugin().getProxy().sendMessage(Component.text(ChatColor.translateAlternateColorCodes('&', this.getPlugin().getConfig().getPrefix() + this.getPlugin().getConfig().getSendVoteText()
