package fr.CraftMyWebsite.CMWLink.Common.Utils.v1_20_R3;
...
public class OfflinePlayerLoader_v1_20_R3 extends OfflinePlayerLoader{
	...
	public Player loadFromOfflinePlayer(OfflinePlayer player) {
		...
		//TODO FIX WORLD
		EntityPlayer entity = new EntityPlayer(server, server.F(), profile, ClientInformation.a());
