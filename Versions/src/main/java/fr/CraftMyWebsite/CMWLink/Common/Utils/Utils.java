		...
		case SPIGOT:
			try {
				...
				if(version != null) {
					...
					offlinePlayerLoader = (OfflinePlayerLoader) Class.forName("fr.CraftMyWebsite.CMWLink.Common.Utils." + version.getPackageName() +".OfflinePlayerLoader_" + version.getPackageName()).newInstance();
					return true;
				}else {
					if(say) {
